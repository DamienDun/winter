...
public class LogAspect {
    ...
    public void getControllerMethodDescription(JoinPoint joinPoint, Log log, SysOperLog operLog, Object jsonResult) throws Exception {
        ...
        if (StringUtils.isEmpty(logTitle) && log.useServiceModuleName()) {
            Method getModuleName = joinPoint.getTarget().getClass().getMethod(DefaultController.METHOD_GET_MODULE_NAME);
            logTitle = String.valueOf(getModuleName.invoke(joinPoint.getTarget()));
        }
