...
import com.winter.common.exception.UtilException;
import com.winter.common.utils.DateUtils;
import com.winter.common.utils.DictUtils;
import com.winter.common.utils.StringUtils;
import com.winter.common.utils.file.FileTypeUtils;
import com.winter.common.utils.file.FileUtils;
import com.winter.common.utils.file.ImageUtils;
...
public class ExcelUtil<T> {
    ...
    public String getAbsoluteFile(String filename) {
        String downloadPath = WinterConfig.getDownloadPath() + filename;
            ...
            if (!ArrayUtils.contains(this.excludeFields, field.getName())) {
                ...
                if (field.isAnnotationPresent(Excels.class)) {
                    ...
                    for (Excel attr : excels) {
                        if (!ArrayUtils.contains(this.excludeFields, field.getName() + Constants.DOT + attr.targetAttr())
    ...
    private boolean isRowEmpty(Row row) {
        ...
        for (int i = row.getFirstCellNum(); i < row.getLastCellNum(); i++) {
            ...
            if (Objects.nonNull(cell) && cell.getCellType() == CellType.STRING && StringUtils.isNotEmpty(cell.getStringCellValue())) {
                return false;
            }
            if (Objects.nonNull(cell) && cell.getCellType() != CellType.BLANK && cell.getCellType() != CellType.STRING) {
                return false;
            }
        }
        return true;
