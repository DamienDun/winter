...
import com.winter.common.exception.file.FileSizeLimitExceededException;
import com.winter.common.exception.file.InvalidExtensionException;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = WinterConfig.getProfile();
    ...
    {
        int dirLastIndex = WinterConfig.getProfile().length() + 1;
